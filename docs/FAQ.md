...
> 如需深入了解系统设计原理和数据模型，请参阅 [ARCHITECTURE.md](./ARCHITECTURE.md)。

> 深度文档：[ARCHITECTURE.md](./ARCHITECTURE.md) | [TROUBLESHOOTING.md](./TROUBLESHOOTING.md)
...
> 完整的排查流程请参阅 [TROUBLESHOOTING.md](./TROUBLESHOOTING.md)。
